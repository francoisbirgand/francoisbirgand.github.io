...
```{r,warning=FALSE,echo=FALSE,eval = TRUE, fig.height=height,fig.width=width,fig.cap="Predicted vs. lab DOC "}
...
```{r,echo=FALSE,eval=TRUE,fig.height=height,fig.width=width,fig.cap="Loadings plotted for Models 3 (red) & 4 (black). Y-axis values correspond to weighted loadings at each absorbance value. Dashed and solid lines indicate Components 1 & 2 of the model, respectively."}
