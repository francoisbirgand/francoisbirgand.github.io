...
image[0] = 'bioreactor-column.png';
image[1] = 'gauging.JPG';
image[2] = 'CLMD_Jun8-18.png';
image[3] = 'Claridge-workers.JPG';
image[4] = 'lonniepoolwetland.png';
image[5] = 'REEP-bioreactor-header.png';
image[6] = 'scan-on-knees.jpg';
...
* **[BAE 587](http://catalog.ncsu.edu/search/?search=bae+587)** – Biogeochemical  Processes for Ecological Engineering (3 hrs. Fall even years, Face to face + Distance Ed. -- instructor)
