...
output: 
  html_document:
    toc: true
    toc_float: true
bibliography: RMD_course_BibTeX.bib
link-citations: true
csl: nature.csl
---
...
<div class = "col-md-3" align="right">*[code for this document](https://raw.githubusercontent.com/francoisbirgand/francoisbirgand.github.io/master/tutorial-RMarkdown_instructions.Rmd)*</div></div>
...
Now, this is really a crash course on R Markdown for the applications I have found most useful until now. But since I started writing this tutorial, the people who have come up with all this fantastic concept have written and released the [Definitivie guide to R Markdown](https://bookdown.org/yihui/rmarkdown/). I cannot recommend enough to go in there to get all important details certainly missing in this tutorial. After browsing through the definitive guide, I find that there is still room for a 'crash course', and I will keep maintaining this tutorial. 

<br/>

# R Markdown in R Studio

I have had a very low opinion of [R studio](https://www.rstudio.com/) until 2017 because I never liked the text editor, I always thought (still do in fact...!) that on a normal screen, things were just too cramped. *But*, I must say that I have come to change my mind, principally thanks to the possibilities that R Markdown offers, and because R Mardown is hosted in [R studio](https://en.wikipedia.org/wiki/RStudio).  
...
```
a link within the text as a [link](www.rstudio.com). Absolute links to images, see [Images](#images) below.
...
Now if you want to center **both figure and caption**, you need to add `<center>` a blank line, the image code, a blank line, then `</center>`, and it will appear like this:
...
You can embed some r code within the text by using Maximum flow = `r signif(max(Q),3)` m&sup3; to give 5 significant digits to the number $\pi$.
